...
program demo
    ...
    dndt_ROT = M_LROT(eps, omg, 1d0, 0d0) ! Assume constant strain-rate and spin with Taylor style plastic spin for lattice rotation.
    dndt_REG = M_REG(eps)
...
!        write(*,"(A9,I3)") '*** Step ', tt
    ...
    write (fname_sol,"('solutions_L20/LATROT_',A5,'.nc')") arg_exp
