...
! Distributed under terms of the GNU GPL3.0 license.
    ...
    FUNCTION FTW( Model, nodenumber, dumy) RESULT(betav)
            USE DefUtils
            USE types
            ...
            IF (FIRSTTIME) THEN
                ...
                WRITE(beta_fn,"(A,I0.3,A)") '../edc_data/v2/ftw.txt'
        ...
        FUNCTION X_sps( Model, nodenumber, dumy) RESULT(betav)
            ...
            IF (FIRSTTIME) THEN
                ...
                WRITE(beta_fn,"(A,I0.3,A)") '../edc_data/v2/x_sps.txt'
      ...
      FUNCTION Y_sps( Model, nodenumber, dumy) RESULT(betav)
            ...
            IF (FIRSTTIME) THEN
                ...
                WRITE(beta_fn,"(A,I0.3,A)") '../edc_data/v2/y_sps.txt'
      ...
      FUNCTION SpatialAcc( Model, nodenumber, dumy) RESULT(betav)
            ...
            IF (FIRSTTIME) THEN
                ...
                WRITE(beta_fn,"(A,I0.3,A)") '../edc_data/v2/acc.txt'
      ...
      FUNCTION SpatialTemp( Model, nodenumber, dumy) RESULT(betav)
            ...
            IF (FIRSTTIME) THEN
                ...
                WRITE(beta_fn,"(A,I0.3,A)") '../edc_data/v2/ts.txt'
      ...
      FUNCTION nlm2sf( Model, nodenumber, dumy) RESULT(T)
            ...
            IF (FIRSTTIME) THEN
                ...
                nentries = 3
                depth = (/ 0.0_dp, 2500.0_dp, 3300.0_dp /)
                betaarr = (/ -0.027_dp, -0.269882_dp, -0.269882_dp /)
            END IF
      ...
      FUNCTION nlm4sf( Model, nodenumber, dumy) RESULT(T)
            ...
            IF (FIRSTTIME) THEN
                ...
                nentries = 3
                depth = (/ 0.0_dp, 2500.0_dp, 3300.0_dp /)
                betaarr = (/ -0.022_dp, -0.220358_dp, -0.220358_dp /)
            END IF
      ...
      FUNCTION nlm7sf( Model, nodenumber, dumy) RESULT(T)
            ...
            IF (FIRSTTIME) THEN
                ...
                nentries = 3
                depth = (/ 0.0_dp, 2500.0_dp, 3300.0_dp /)
                betaarr = (/ 0.019_dp, 0.186445_dp, 0.186445_dp /)
            END IF
      ...
      FUNCTION nlm9sf( Model, nodenumber, dumy) RESULT(T)
            ...
            IF (FIRSTTIME) THEN
                ...
                nentries = 3
                depth = (/ 0.0_dp, 2500.0_dp, 3300.0_dp /)
                betaarr = (/ 0.014_dp, 0.140939_dp, 0.140939_dp /)
            END IF
      ...
      FUNCTION nlm11sf( Model, nodenumber, dumy) RESULT(T)
            ...
            IF (FIRSTTIME) THEN
                ...
                nentries = 3
                depth = (/ 0.0_dp, 2500.0_dp, 3300.0_dp /)
                betaarr = (/ 0.013_dp, 0.133706_dp, 0.133706_dp /)
            END IF
      ...
      FUNCTION nlm15sf( Model, nodenumber, dumy) RESULT(T)
            ...
            IF (FIRSTTIME) THEN
                ...
                nentries = 3
                depth = (/ 0.0_dp, 2500.0_dp, 3300.0_dp /)
                betaarr = (/ 0.0186445_dp, 0.186445_dp, 0.186445_dp /)
            END IF
      ...
      FUNCTION nlm2sfa( Model, nodenumber, dumy) RESULT(T)
            ! Temp with depth
            USE DefUtils
            USE types
            ...
            IF (FIRSTTIME) THEN
                ...
                nentries = 3
                depth = (/ 0.0_dp, 2500.0_dp, 3300.0_dp /)
                betaarr = (/ -0.06180387_dp, -0.269882_dp, -0.269882_dp /)
            END IF
      ...
      FUNCTION nlm4sfa( Model, nodenumber, dumy) RESULT(T)
            ! Temp with depth
            USE DefUtils
            USE types
            ...
            IF (FIRSTTIME) THEN
                ...
                nentries = 3
                depth = (/ 0.0_dp, 2500.0_dp, 3300.0_dp /)
                betaarr = (/ -0.05046265_dp, -0.220358_dp, -0.220358_dp /)
            END IF
      ...
      FUNCTION nlm6sfa( Model, nodenumber, dumy) RESULT(T)
            ! Temp with depth
            USE DefUtils
            USE types
      ...
      FUNCTION nlm7sfa( Model, nodenumber, dumy) RESULT(T)
            ! Temp with depth
            USE DefUtils
            USE types
      ...
      FUNCTION nlm9sfa( Model, nodenumber, dumy) RESULT(T)
            ! Temp with depth
            USE DefUtils
            USE types
      ...
      FUNCTION nlm11sfa( Model, nodenumber, dumy) RESULT(T)
            ! Temp with depth
            USE DefUtils
            USE types
      ...
      FUNCTION nlm13sfa( Model, nodenumber, dumy) RESULT(T)
            ! Temp with depth
            USE DefUtils
            USE types
      ...
      FUNCTION nlm15sfa( Model, nodenumber, dumy) RESULT(T)
            ! Temp with depth
            USE DefUtils
            USE types
