...
expr_Hunter = {
    ...
    "type": "ucw",
    "coords": "quaternion",
    "flist": ["MD14/md14.csv", "MD12/md12.csv", "MD4/md4.csv", "MD22/md22.csv", "MD9/md9.csv", "MD3/md3.csv", "MD13/md13.csv", "D1-1/D1-1_pf.csv", "D1-5/D1-5_pf.csv", "D1-7/D1-7_pf.csv", "D5-1/D5-1_pf.csv", "D5-3/D5-3_pf.csv"],
    "skiprows": 0,
    "sep": ",",
    "color": "tab:gray",
}
...
expr_Fan_10 = {
    ...
    "coords": "quaternion",
    "flist": [
        "series_-10/PIL007_30mu.crc.csv",
        "series_-10/PIL163_30mu.crc.csv",
        "series_-10/PIL177_30mu.crc.csv",
        "series_-10/PIL178_30mu.crc.csv",
    ],
    "skiprows": 0,
    "sep": ",",
    "color": "#e31a1c",
...
files = np.sort([int(os.path.basename(f)[3:]) for f in glob.glob("LAWDOME/SPLITTED/DSS*")])
expr_LAWDOME = {
    "path": "LAWDOME",
    "plotname": "Law Dome",
    "type": "uc",
